            ...
            <header className="bg-white border-b border-gray-100">
                ...
                ${isOpen ? '-translate-y-[7px] -rotate-45' : ''}`}
                        ...
                        <div className="flex items-center gap-4 text-gray-700">
                            <NavLink to="/search" className="hover:text-orange-500">
                                <svg className="w-[20px] h-[20px]" width="800" height="800" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M21.71 20.29 18 16.61A9 9 0 1 0 16.61 18l3.68 3.68a1 1 0 0 0 1.42 0 1 1 0 0 0 0-1.39M11 18a7 7 0 1 1 7-7 7 7 0 0 1-7 7"/></svg>
                            </NavLink>
